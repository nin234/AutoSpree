        ...
        == kCFCompareEqualTo) 
    {
        ...
        == kCFCompareEqualTo) 
     {
        ...
        // [imagePickerController dismissModalViewControllerAnimated:NO];
         ...
         //[imagePickerController dismissModalViewControllerAnimated:NO];
        // NSLog(@"Dismissed imagePickerController about to show it again\n");
          //[self presentModalViewController:imagePickerController animated:YES];
         //  NSLog(@"Showing imagePickerController it again\n");
     }
...
tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
    ...
    NSLog(@"Showing row in AddViewController row %ld in section %ld\n",(long)indexPath.row, (long)indexPath.section);
