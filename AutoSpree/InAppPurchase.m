...
-(void) completeTransaction:(SKPaymentTransaction *) transaction
{
    ...
    if ([transaction.payment.productIdentifier isEqualToString:@"com.rekhaninan.autospree_full"])
    {
...
-(void) restoreTransaction:(SKPaymentTransaction *) transaction
{
    ...
    if ([transaction.payment.productIdentifier isEqualToString:@"com.rekhaninan.autospree_full"])
    {
        ...
        [pDlg setPurchsd];
        bIgnoreAlertVwClck = true;
        UIAlertView *pAvw = [[UIAlertView alloc] initWithTitle:@"Success" message:@"Restored AutoSpree feature to add unlimited number of cars" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
...
-(InAppPurchase *) init
{
    ...
    NSSet * productIdentifiers = [NSSet setWithObjects:
                                  @"com.rekhaninan.autospree_full", nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    switch (buttonIndex)
    {
        case YES_TO_PAY:
        {
            ...
            if (bPurchase)
            {
                NSLog(@"Purchasing AutoSpree unlock");
                [[SKPaymentQueue defaultQueue] addPayment:payment];
            }
            else
            {
                 NSLog(@"Restoring AutoSpree unlock");
